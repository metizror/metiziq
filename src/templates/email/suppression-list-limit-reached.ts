interface SuppressionListLimitReachedTemplateData {
    count: number;
}

export function getSuppressionListLimitReachedTemplate(data: SuppressionListLimitReachedTemplateData): string {
    const { count } = data;
    ...
    <html lang="en">
      <head>
        ...
        <title>Suppression List Uploaded Limit reached</title>
      </head>
                ...
                <tr>
                  <td style="padding: 40px 40px 30px 40px; text-align: left;">
                    <h1 style="margin: 0 0 20px 0; font-size: 24px; font-weight: 600; color: #111827; line-height: 1.3;">
                      Suppression List Uploaded Limit reached
                    </h1>
                    <p style="margin: 0 0 20px 0; font-size: 16px; line-height: 1.6; color: #374151;">
                      Suppression List Uploaded Exceeds Allowed Limit of 10,000 records.    
                    </p>
                  </td>
                </tr>
                <tr>
