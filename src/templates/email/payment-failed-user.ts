interface PaymentFailedUserTemplateData {
  customerName: string;
  paymentLink: string;
}

export function getPaymentFailedUserTemplate(data: PaymentFailedUserTemplateData): string {
  const { customerName, paymentLink } = data;
