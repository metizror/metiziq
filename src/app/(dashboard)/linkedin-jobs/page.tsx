                                    ...
                                    <div className="flex flex-col md:flex-row gap-4 items-start justify-between">
                                        <div className="space-y-2 flex-1">
                                            ...
                                            <div className="text-sm text-gray-600 font-medium">
                                                {job.company || job.company_name || "Unknown Company"} &bull; {job.location || "No Location"}
                                            </div>

                                            <div className="flex flex-wrap gap-2 text-xs mt-2">
                                                {job.type && <span className="bg-blue-100 text-blue-800 px-2 py-0.5 rounded-full">{job.type}</span>}
                                                {job.work_arrangement && <span className="bg-purple-100 text-purple-800 px-2 py-0.5 rounded-full">{job.work_arrangement}</span>}
                                                {job.posted_at && <span className="bg-gray-100 text-gray-800 px-2 py-0.5 rounded-full">Posted: {job.posted_at}</span>}
                                            </div>
                                        ...
                                        <div className="flex flex-col gap-2 min-w-[120px]">
                                            <a
                                                href={job.linkedin_url || job.url || `https://www.linkedin.com/jobs/view/${job.job_id}`}
                                                target="_blank"
